...
public class rock_paper_scissors_9{
	...
	public static String[][] getavg_percent(int[] result,int rounds){
		...
		double userstats=result[0]/rounds;
		double computerstats=result[1]/rounds;
		int userpercent= (int)userstats*100;
		int computerpercent=(int)computerstats*100;
	...
	public static int[] game(int rounds){
		...
		for (int i=0;i<rounds;i++){
			...
			int computer_choice=rock_paper_scissors.getcomputerchoice();
	...
	public static void main(String[] args){
		...
		int[] result=rock_paper_scissors.game(rounds);
		rock_paper_scissors.getwinner(result);
		String[][] avg_percent=rock_paper_scissors.getavg_percent(result,rounds);
		rock_paper_scissors.showdisplay(avg_percent);
		}
